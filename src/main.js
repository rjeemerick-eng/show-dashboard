    ...
    if (win) {
      win.webContents.executeJavaScript(`
        (function() {
          ...
          banner.style.cssText = 'position:fixed;top:0;left:0;right:0;z-index:99999;background:#1a1f2e;border-bottom:1px solid rgba(55,138,221,0.5);padding:10px 20px;display:flex;align-items:center;justify-content:space-between;font-family:Inter,system-ui,sans-serif;font-size:13px;color:#e8e9ef';
          banner.innerHTML = '<div><span style="color:#7eb8f5;font-weight:600">⬆ Update available — v${info.version}</span><span style="color:rgba(255,255,255,0.5);margin-left:10px">Downloading in background…</span></div>';
